...
<div class="container">
    ...
    <form action="save.php" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone" value="<?php echo htmlspecialchars($defaultValues['phone'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
        </div>

        <div class="form-group">
            <label>3. E-mail *</label>
            <input type="text" name="email" value="<?php echo htmlspecialchars($defaultValues['email'] ?? '', ENT_QUOTES, 'UTF-8'); ?>">
        </div>
        ...
        <div class="form-group">
            ...
            <select name="languages[]" multiple>
                <?php foreach ($languagesList as $lang): ?>
                    <option value="<?php echo htmlspecialchars($lang['id'], ENT_QUOTES, 'UTF-8'); ?>" <?php echo in_array($lang['id'], $defaultLanguages) ? 'selected' : ''; ?>>
        ...
        <div class="form-group">
            ...
            <textarea name="biography" rows="5"><?php echo htmlspecialchars($defaultValues['biography'] ?? '', ENT_QUOTES, 'UTF-8'); ?></textarea>
        </div>
